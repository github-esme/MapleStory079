...
var sss ="#fUI/UIWindow.img/QuestIcon/3/0#";
	...
	if (status == 0) {
		...
		//textz += "#d#L0#收集#v4000014##b#z4000014##r 50 #d个可兑换#r#v4000313#5张\r\n";

		//textz += "#d#L1#收集#v4000061##b#z4000061##r 50 #d个可兑换#r#v4000313#5张\r\n";
		...
		textz += "#d#L5#收集#v4000161##b#z4000161##r 50 #d个可兑换#r#v4000313#5张\r\n";

		textz += "#d#L6#收集#v4000052##b#z4000052##r 50 #d个可兑换#r#v4000313#5张\r\n";

		textz += "#d#L7#收集#v4000190##b#z4000190##r 50 #d个可兑换#r#v4000313#5张\r\n";
	...
	if (selection == 0) {
if (cm.haveItem(4000014,50) && cm.getBossLog('PlayQuest1') < 1) {
cm.dispose();
	...
	if (cm.haveItem(4000061,50) && cm.getBossLog('PlayQuest2') < 1) {
	...
	if (cm.haveItem(4000161,50) && cm.getBossLog('PlayQuest6') < 1) {
		cm.gainItem(4000161,-50);
		cm.setBossLog('PlayQuest6');
		cm.gainItem(400313,5);
		cm.gainExp( + 100000);
		cm.sendOk("任务完成,获得 额外赠送的\r\n10万经验!");
		cm.dispose();
	} else 
	...
	if (cm.haveItem(4000052,50) && cm.getBossLog('PlayQuest7') < 1) {
		cm.gainItem(4000052,-50);
	...
	if (cm.haveItem(4000190,50) && cm.getBossLog('PlayQuest8') < 1) {
