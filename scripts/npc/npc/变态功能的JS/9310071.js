...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple ("您好，尊敬的 #b#h ##k, 我是怀旧冒险岛的#r兑换系统#k负责人\r\n\r\n\n#L2#100张#d#v4001126##d=====#r5,000点券#k#n#l\r\n#L4#10张#d#v4000313##d======#r300W 金币#n#l#k\r\n#L5#10只#d#v4032226##d=====#r300W 金币#n#l#k\r\n");
        } else if (status == 1) {
            switch(selection) {
        case 0:
         ...
         case 2: 
            if(cm.haveItem(4001126,100)){
				...
				cm.sendOk("恭喜你，你获得了 5000 点券! .");
			        cm.worldMessage(6,"【兑换系统】["+cm.getName()+"]100张枫叶兑换5000点卷成功！");
				cm.dispose();
            }else{
